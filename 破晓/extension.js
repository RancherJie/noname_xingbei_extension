game.import("extension",function(lib,game,ui,get,ai,_status){return {name:"破晓",content:function (config,pack){
    ...
    character:{
        character:{
<<<<<<< HEAD
            daDiWuShi:["male","xue",2,["diMaiZhiLi","poXieZhan","shengShengBuXi","gaiYaHuaShen"],["des:阿基特"]],
            xinLinSuShi:["female","huan",4,["huanXiangChongJi","xinLingFengBao","zhenShiHuanJue","gaiBianShiJie"],["des:对于胜利为主要目的而不择手段的人，被称之为胜负师，而将这一切运用到极致的艾莉西娅，完全无愧于命运胜负师的这一称号。对于心灵魔法下属的魅惑魔法、暗示魔法、命令魔法以及支配魔法全部精通的她来说，利用这些能力将他人操纵于鼓掌之中甚至已经成为了一种习惯。<br>对于这次的龙族入侵，艾西莉娅自然不会放弃这个为自己和幻影联盟谋取利益的绝好机会，没人知道她究竟有什么打算，但所有人都相信，她的所作所为会永远的改变整个世界。<br>博弈色彩浓重的角色，发挥既取决于自身的能力和牌运，也受对面的影响。"]],
            caiJueZheP:["female","sheng",3.5,["zhengYiZhuiJi","caiJueZhiXing","zhenLiCaiJue","songZhongDaoFeng","wuJinZhiRen"],["des:仲裁厅一直是神圣教廷内部最为神秘的部门，如果说光辉神殿的使命是向世人散布神的荣光和怜悯，那么仲裁厅便是他冷酷而无情的另一面。仲裁厅的执行人员，主要负责处理『神秘遗物』以及处理相关的事件以及清除拥有危险力量的渎神者和叛教者。仲裁厅所属的人员包括圣殿骑士和战争祭司，总人数极少，由被称为『裁决者』的十余名特别骑士所管辖。<br>面对突如其来的龙族入侵，这个神秘而特殊的机构终于将他的面目展露在世人面前，这次事件中带队的裁决者的代号为“路西菲尔”。<br>拥有额外行动能力的魔武双修的角色，节奏顺的时候很强，节奏不顺的时候发挥大受限制。"]],
            zhanXingJia:["female","yong",2,["zhanBuWeiLai","lieYanFenShen","hanBingHuTi","leiTingZhiNu","guangYingXiangSheng","daYuYanShu","yuZhao"],["des:作为咏歌城的首席占星家，蒂雅拥有着令人难以想象的天赋，由他所创造的快速占卜法术让占星家真正有了在战场上正面作战的能力，这对于星象法术的贡献可谓是居功至伟。但由于深知关于命运法术的难测与危险性，与其兄斯通的分歧日益严重，并最终因他错误的决定导致了两人反目成仇。而斯通的叛逃，一直是蒂雅心中最大的阴影。"]],
=======
            ...
            caiJueZheP:['female','sheng','3/4',['zhengYiZhuiJi','caiJueZhiXing','zhenLiCaiJue','songZhongDaoFeng','wuJinZhiRen'],
...
>>>>>>> ad9886a60515578f8b538188a0d34b14f6d33968
        },
        translate:{
            daDiWuShi:"大地武士",
            xinLinSuShi:"心灵塑师",
